 ...
 *
 */
package com.dude.prehistoricworld;
...
public class PrehistoricWorldMod {
	public static final Logger LOGGER = LogManager.getLogger(PrehistoricWorldMod.class);
	public static final String MODID = "prehistoric_world";
